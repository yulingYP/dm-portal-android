...
public class ReasonTypeListLayout extends LinearLayout {
    ...
    public class ReasonAdapter extends RecyclerView.Adapter<ReasonAdapter.ViewHolder>{
        ...
        @Override
        public void onBindViewHolder(@NonNull ReasonAdapter.ViewHolder holder, @SuppressLint("RecyclerView") int position) {
    ...
    public class CheckApprovalAdapter extends RecyclerView.Adapter<CheckApprovalAdapter.ViewHolder>{
        ...
        private CheckApprovalAdapter(List<ApprovalRecord> approvalRecordList) {
...
//            }
            //审批人
            String name = approvalRecordList.get(position).getApproverName();
            name = "".equals(name)?String.valueOf(approvalRecordList.get(position).getApproverId()):name;
            holder.tv_name.setText(mContext.getString(R.string.approver_text,name));
