package com.example.dmportal.main;
...
import com.example.dmportal.BuildConfig;
import com.example.dmportal.MyActivityManager;
import com.example.dmportal.R;
import com.example.dmportal.appstore.AppLyListActivity;
import com.example.dmportal.appstore.ApplyInfoActivity;
import com.example.dmportal.appstore.ApprovalApplyInfoActivity;
import com.example.dmportal.appstore.ApprovalLeaveInfoActivity;
import com.example.dmportal.appstore.LeaveInfoDetailActivity;
import com.example.dmportal.appstore.LeaveListActivity;
import com.example.dmportal.appstore.bean.MyMessage;
import com.example.dmportal.appstore.customViews.NoScrollViewPager;
import com.example.dmportal.appstore.leaveSettingUI.AuthoritySettingActivity;
...
import com.example.dmportal.config.MyCongfig;
import com.example.dmportal.main.presenter.MainPresenter;
import com.example.dmportal.main.presenter.UserInfoPresent;
import com.example.dmportal.appstore.ui.fragment.HomeAppFragment;
import com.example.dmportal.main.ui.fragment.MsgFragment;
import com.example.dmportal.main.ui.fragment.MyFragment;
...
//            title = myMessage.getMessageId();
    ...
    public Intent setResultIntent(MyMessage myMessage) {
        ...
        if(myMessage.getMessageType()==1){//请假人请假结果
            ...
            intent.putExtra("leaveId",DensityUtil.string2Long(myMessage.getMessageExtend()));
            ...
            intent.putExtra("leaveId", DensityUtil.string2Long(infoId));
            ...
            intent.putExtra("applyId", DensityUtil.string2Long(infoId));
            intent.putExtra("type", myMessage.getMessageExtend2().intValue());
